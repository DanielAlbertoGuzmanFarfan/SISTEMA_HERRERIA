...
<head>
	...
	<script type="text/javascript" src="js/buscar_materias.js"></script>
  	...
  	<form action="#" method="post" name="formu">
  		<table border="1" class="listado">
  			<tr>
		        ...
		        {foreach item=r from=$materias}
		        <option value="{$r.id_materia}">{$r.carrera}</option>
		        {/foreach}
		        </select>
		        </th>
  				<th>
  					<b>MATERIA</b><br />
  					<input type="text" name="materia" value="" size="10" onkeyup="buscar_materias()">
  				</th>
  				<th>
  					<b>ALIAS</b><br />
  					<input type="text" name="alias" value="" size="10" onkeyup="buscar_materias()">
  				</th>
  			</tr>
  		</table>
  	</form>

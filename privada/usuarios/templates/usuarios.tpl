			...
			<tr>
				...
				<td align="center">
					<form name="formModif{$r.id_usuario}" method="post" action="usuario_modificar.php">
						...
						<a href="javascript:document.formModif{$r.id_usuario}.submit();" title="modificar usuario">
							MODIFICAR
						</a>						
					</form>					
				</td>
				<td align="center">
					<form name="formElimi{$r.id_usuario}" method="post" action="usuario_eliminar.php">
						<input type="hidden" name="id_usuario" value="{$r.id_usuario}">
						<a href="javascript:document.formElimi{$r.id_usuario}.submit();" title="eliminar usuario"
						onclick='javascript:return(confirm("desea realmente eliminar al usuario:::{$r.usuario}..?"));'>ELIMINAR					
						</a>						
					</form>				
				</td>
